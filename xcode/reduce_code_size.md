### Reduce code size of the framework, from 3.7M to 120K+.
...
|方案 | Deployment Postprocessing: YES | Strip Style :non-global | attribute visibility hidden | 模版改为宏 | __TEXT __DATA 大小 | __LINKEDIT 大小 | 总大小|
|---|---|---|---|---|---|---|---|
|1   |✗    |✗    |✗    |✗    |952K    |2.6M    |3.7M|
|2   |✅   |✗    |✗    |✗    |952K    |1.5M    |2.5M|
|3   |✅   |✅   |✗    |✗    |952K    |990K    |2M|
